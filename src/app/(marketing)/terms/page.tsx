...
function TermsPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      body:  "AI-powered features (auto-fill, spending insights) are provided for convenience and informational purposes only. Outputs are generated by third-party AI models (Groq / LLaMA) and may contain errors. Subsight makes no warranty about the accuracy of AI outputs. Do not use AI-generated financial insights as your sole basis for financial decisions.",
    },
    {
